...
const build_query_helper_1 = require("../utils/build-query.helper");
const statusCodes_1 = require("../constants/statusCodes");
const getAllHandler = (model, searchFields, omitFields) => {
    return async (req, res, next) => {
        try {
            const result = await (0, build_query_helper_1.buildQuery)(model, req.query, searchFields, omitFields);
